...
export default class HelloWorld extends React.Component<IHelloWorldProps, IReactSpFxPnP> {
      ...
      <form>
        <div className={styles.helloWorld}>
          <div className={styles.container}>
            <div
              className={`ms-Grid-row ms-bgColor-neutralLight ms-fontColor-white ${
                styles.row
              }`}
            >
              ...
              <div className="ms-Grid-col ms-u-sm8 block">
                <Dropdown
                  ...
                  id="component"
                  selectedKey={
                    dpselectedItem ? dpselectedItem.key : undefined
                  }
              ...
              <div>
                ...
                >
                  <span>
                    Please check the details filled and click on Confirm
  ...
  private createItem(): void {
    ...
    pnp.sp.web.lists
      .getByTitle("Employee Registration")
      .items.add({
        ...
        ExternalHiring:this.state.defaultChecked
      })
      .then((iar: ItemAddResult) => {
        this.setState({
          status: "Your request has been submitted sucessfully "
        });
      });
  }
